...
Lemma wfLocking_async_preservation :
  forall P Gamma H H' V V' n n' T1 T1' T2 t nature ncs,
    wfConfiguration P Gamma (H, V, n, T1) t nature ncs -> (*!!*)
    wfLocking H T2 ->
    disjointLocks T1 T2 ->
    P / (H, V, n, T1) ==> (H', V', n', T1') ->
    wfLocking H' T2.
...
Lemma spawn_no_locks :
  forall P Gamma e t H V n Ls e1 e2 e3 n' ncs',
...
Lemma noLostLocks :
  forall P Gamma l H H' V V' n n' T T' t nature ncs,
    In l (leftmost_locks T) ->
    ~ In l (t_locks T) ->
    wfConfiguration P Gamma (H, V, n, T) t nature ncs -> (*!!*)
    P / (H, V, n, T) ==> (H', V', n', T') ->
    In l (leftmost_locks T').
Proof with eauto.
  introv HIn HnIn wfCfg Hstep.
  gen T' t nature ncs. induction T; intros. (*!!*)
  + inv_step.
  + inverts wfCfg as Hlt wfH wfV wfT wfL.
...
Lemma noDuplicatedLocks :
  forall P t' Gamma l H H' V V' n n' T T' t c F mcs nature ncs,
    wfProgram P t' mcs -> (*!!*)
  ...
  + rename l0 into Ls.
    ...
    - Case "T_Call".
      ...
      * rewrite <- locks_subst. rewrite <- locks_subst.
        ...
        inv H19. inv H. apply locks_static in H15. rewrite H15. (*!!*)
        contra...
    - Case "T_Update".
      inv Hfree. destruct_var; try(congruence).
      apply wfLocks_econtext in wfL...
...
Theorem wfLocking_preservation :
  forall P t' Gamma H H' V V' n n' T T' t mcs nature ncs,
    wfProgram P t' mcs -> (*!!*)
    wfConfiguration P Gamma (H, V, n, T) t nature ncs -> (*!!*)
    P / (H, V, n, T) ==> (H', V', n', T') ->
    wfLocking H' T'.
  ...
  + rename l into Ls.
    ...
    - Case "T_Call".
      ...
      * clear IHhasType.
        ...
        assert (wfMtd: exists mcs_M, wfMethodDecl P c mcs_M (Method m (y0, t0) t'0 body)) (*!!*)
by eauto using wfProgram_wfMethodDecl.
  ...
  + inverts wfCfg as Hlt wfH wfV wfT wfL.
    ...
    - assert (Hdisj': disjointLocks T1' T2)
      ...
      assert(wfCfg1: wfConfiguration P Gamma (H, V, n, T1) t1 n1 ncs1)... (*!!*)
      pose proof (IHT1 _ _ _ _ Hstep t1 n1 ncs1 wfCfg1) as IH. (*!!*)
      inv wfL.
      econstructor...
      * econstructor...
    ...
    - assert (Hdisj': disjointLocks T1 T2')
      ...
      assert(wfCfg2: wfConfiguration P Gamma (H, V, n, T2) t2 n2 ncs2)... (*!!*)
    - inv wfL1...
    - econstructor...
